...
class _SignalTestScreenState extends State<SignalTestScreen> {
  ...
  initialize() async {
    ...
    await aliceModel!.buildSession(bob, receiverKeyBundle);
    // Building session can create fingerprint for this session. Fingerprint can be generated for both user when both users have created as session.
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(color: Colors.black12, child: mainBody),
    );
  }
}
